...
var DanhSachBaiThuocComponent = (function () {
    ...
    DanhSachBaiThuocComponent.prototype.doSearchBaiThuoc = function (text) {
        ...
        if (text === '') {
            ...
            this.baithuocService.getBaithuoc(1).subscribe(function (data) {
                _this.DsBaiThuoc = data.DsBaiThuoc.DsBaiThuoc;
                _this.TongSoLuongBaiThuoc = data.TongSoLuongBaiThuoc;
            ...
            setTimeout(function () {
                _this.baithuocService.getSearchBaithuoc(text).subscribe(function (data) {
                    _this.DsBaiThuoc = data.DsBaiThuoc.DsBaiThuoc;
                    _this.TongSoLuongBaiThuoc = data.DsBaiThuoc.TongSoLuongBaiThuoc;
                    _this.startBaithuoc = 0;
                    _this.endBaithuoc = data.TongSoLuongBaiThuoc;
    ...
    DanhSachBaiThuocComponent.prototype.doSearchViThuoc = function (text) {
        ...
        if (text === '') {
            this.isSearch = false;
            this.vithuocService.getVithuoc(1).subscribe(function (data) {
                _this.DsViThuoc = data.DsViThuoc.DsViThuoc;
                _this.TongSoLuongViThuoc = data.TongSoLuongViThuoc;
            ...
            setTimeout(function () {
                _this.vithuocService.getSearchVithuoc(text).subscribe(function (data) {
                    _this.DsViThuoc = data.DsViThuoc.DsViThuoc;
                    _this.TongSoLuongViThuoc = data.DsViThuoc.TongSoLuongViThuoc;
                    _this.startVithuoc = 0;
                    _this.endVithuoc = data.TongSoLuongViThuoc;
    ...
    DanhSachBaiThuocComponent.prototype.onScrollViThuoc = function () {
        ...
        if (this.isSearch || this.page > this.TongSoLuongViThuoc / 50) {
            ...
            this.loadMore = true;
            this.page++;
            this.vithuocService.getVithuoc(this.page).subscribe(function (data) {
    ...
    DanhSachBaiThuocComponent.prototype.doSearchChePhamThuoc = function (text) {
        ...
        if (text === '') {
            this.isSearch = false;
            this.chephamthuocService.getChephamthuoc(1).subscribe(function (data) {
                _this.DsChePhamThuoc = data.DsChePhamThuoc.DsChePhamThuoc;
                _this.TongSoLuongChePhamThuoc = data.TongSoLuongChePhamThuoc;
            ...
            this.searchUpdate.next(text);
            setTimeout(function () {
                _this.chephamthuocService.getSearchChephamthuoc(text).subscribe(function (data) {
                    _this.DsChePhamThuoc = data.DsChePhamThuoc.DsChePhamThuoc;
                    _this.TongSoLuongChePhamThuoc = data.DsChePhamThuoc.TongSoLuongChePhamThuoc;
                    _this.startChephamthuoc = 0;
                    _this.endChephamthuoc = data.TongSoLuongChePhamThuoc;
    ...
    DanhSachBaiThuocComponent.prototype.onScrollChePhamThuoc = function () {
        ...
        if (this.isSearch || this.page > this.TongSoLuongChePhamThuoc / 50) {
            ...
            this.loadMore = true;
            this.page++;
            this.vithuocService.getChephamthuoc(this.page).subscribe(function (data) {
    ...
    DanhSachBaiThuocComponent.prototype.doSearchDuocThien = function (text) {
        ...
        if (text === '') {
            this.isSearch = false;
            this.DuocthienService.getDuocthien(1).subscribe(function (data) {
                _this.DsDuocThien = data.DsDuocThien.DsDuocThien;
                _this.TongSoLuongDuocThien = data.TongSoLuongDuocThien;
            ...
            this.searchUpdate.next(text);
            setTimeout(function () {
                _this.duocthienService.getSearchDuocthien(text).subscribe(function (data) {
                    _this.DsDuocThien = data.DsDuocThien.DsDuocThien;
                    _this.TongSoLuongDuocThien = data.DsDuocThien.TongSoLuongDuocThien;
                    _this.startDuocthien = 0;
                    _this.endDuocthien = data.TongSoLuongDuocThien;
    ...
    DanhSachBaiThuocComponent.prototype.onScrollDuocThien = function () {
        ...
        if (this.isSearch || this.page > this.TongSoLuongDuocThien / 50) {
            ...
            this.loadMore = true;
            this.page++;
            this.duocthienService.getDuocthien(this.page).subscribe(function (data) {
