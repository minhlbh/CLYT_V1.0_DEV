...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Services_autoComplete_service__ = __webpack_require__("../../../../../src/app/Share/Services/autoComplete.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Services_benh_service__ = __webpack_require__("../../../../../src/app/Share/Services/benh.service.ts");
...
var AutoCompleteComponent = (function () {
    function AutoCompleteComponent(AutoCompleteService, benhService, completerService) {
        var _this = this;
        ...
        this.searchKey = new __WEBPACK_IMPORTED_MODULE_0__angular_forms__["c" /* FormControl */]('');
        this.empty = false;
        this.dataService = completerService.local(this.searchData, 'color', 'color');
        this.searchKey.valueChanges
            .debounceTime(1000)
            .subscribe(function (event) {
            _this.doSearchAutoBenh(event);
    ...
    // autocomplete benh
    AutoCompleteComponent.prototype.doSearchAutoBenh = function (text) {
        var _this = this;
        // no keyword catched => return all
        if (text === '') {
            this.isSearch = false;
            this.benhService.getBenh(1).subscribe(function (data) {
                _this.DsBenh = data.DsBenh.DsBenh;
                _this.TongSoLuong = data.DsBenh.TongSoLuong;
                console.log(_this.DsBenh);
            });
            ...
            setTimeout(function () {
                _this.benhService.getSearchBenh(text).subscribe(function (data) {
                    ...
                    _this.TongSoLuong = data.DsBenh.TongSoLuong;
                    _this.startBenh = 0;
                    _this.endBenh = data.DsBenh.TongSoLuong;
...
], AutoCompleteComponent.prototype, "ngOnInit", null);
AutoCompleteComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__Services_autoComplete_service__["a" /* AutoCompleteService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__Services_autoComplete_service__["a" /* AutoCompleteService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__Services_benh_service__["a" /* BenhService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__Services_benh_service__["a" /* BenhService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4_ng2_completer__["b" /* CompleterService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_ng2_completer__["b" /* CompleterService */]) === "function" && _c || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__window_window_component__ = __webpack_require__("../../../../../src/app/Share/Components/window/window.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Share_Pipes_safe_pipe__ = __webpack_require__("../../../../../src/app/Share/Pipes/safe.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Apps_Tracuubenh_chi_tiet_benh_chi_tiet_benh_component__ = __webpack_require__("../../../../../src/app/Apps/Tracuubenh/chi-tiet-benh/chi-tiet-benh.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_img_load_du_lieu_img_component__ = __webpack_require__("../../../../../src/app/Apps/Tracuubenh/chi-tiet-benh/Load-items/load-du-lieu-img/load-du-lieu-img.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_link_load_du_lieu_link_component__ = __webpack_require__("../../../../../src/app/Apps/Tracuubenh/chi-tiet-benh/Load-items/load-du-lieu-link/load-du-lieu-link.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_text_load_du_lieu_text_component__ = __webpack_require__("../../../../../src/app/Apps/Tracuubenh/chi-tiet-benh/Load-items/load-du-lieu-text/load-du-lieu-text.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_youtube_load_du_lieu_youtube_component__ = __webpack_require__("../../../../../src/app/Apps/Tracuubenh/chi-tiet-benh/Load-items/load-du-lieu-youtube/load-du-lieu-youtube.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Apps_Tracuubenh_forum_bar_forum_bar_component__ = __webpack_require__("../../../../../src/app/Apps/Tracuubenh/forum-bar/forum-bar.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_ngx_facebook__ = __webpack_require__("../../../../ngx-facebook/dist/esm/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__Services_setting_service__ = __webpack_require__("../../../../../src/app/Share/Services/setting.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__autoComplete_autoComplete_component__ = __webpack_require__("../../../../../src/app/Share/Components/autoComplete/autoComplete.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__Services_autoComplete_service__ = __webpack_require__("../../../../../src/app/Share/Services/autoComplete.service.ts");
...
ShareModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__Share_Pipes_safe_pipe__["a" /* SafePipe */],
            __WEBPACK_IMPORTED_MODULE_6__Apps_Tracuubenh_chi_tiet_benh_chi_tiet_benh_component__["a" /* ChiTietBenhComponent */],
            __WEBPACK_IMPORTED_MODULE_7__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_img_load_du_lieu_img_component__["a" /* LoadDuLieuImgComponent */],
            __WEBPACK_IMPORTED_MODULE_8__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_link_load_du_lieu_link_component__["a" /* LoadDuLieuLinkComponent */],
            __WEBPACK_IMPORTED_MODULE_9__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_text_load_du_lieu_text_component__["a" /* LoadDuLieuTextComponent */],
            __WEBPACK_IMPORTED_MODULE_10__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_youtube_load_du_lieu_youtube_component__["a" /* LoadDuLieuYoutubeComponent */],
            __WEBPACK_IMPORTED_MODULE_11__Apps_Tracuubenh_forum_bar_forum_bar_component__["a" /* ForumBarComponent */],
            __WEBPACK_IMPORTED_MODULE_14__autoComplete_autoComplete_component__["a" /* AutoCompleteComponent */],
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_4__window_window_component__["a" /* WindowComponent */],
            __WEBPACK_IMPORTED_MODULE_5__Share_Pipes_safe_pipe__["a" /* SafePipe */],
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_15__Services_autoComplete_service__["a" /* AutoCompleteService */],
        ]
    })
], ShareModule);
...
var AutoCompleteService = (function () {
    ...
    AutoCompleteService.prototype.autoComplete = function (key, apiUrl) {
        var autoCompleteUrl = "" + this.baseUrl + apiUrl + "?Trang=1&searchTerm=" + key + "&soluongmoitrang=15";
...
var CtrInput = (function () {
    ...
    CtrInput.ctorParameters = function () { return [
        ...
        { type: __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* NgModel */], },
        { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"], },
    ]; };
...
var Ng2CompleterModule = (function () {
    ...
    Ng2CompleterModule.decorators = [
        { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"], args: [{
                    imports: [
                        __WEBPACK_IMPORTED_MODULE_12__angular_common__["e" /* CommonModule */],
