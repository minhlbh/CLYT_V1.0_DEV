...
module.exports = "<app-window [name]=\"ChiTietBenh?.TenBenh\" [url]=\"url\">\r\n    <!-- loading -->\r\n    <div class=\"content-wr\">\r\n        <div style=\"text-align: center\">\r\n            <p class=\"lead\" *ngIf=\"loading\">\r\n                <img src=\"assets/66.gif\">\r\n            </p>\r\n        </div>\r\n        <!-- Start content left -->\r\n        <div class=\"bt-bar\">\r\n            <a [routerLink]= \"['taomoi']\" href=\"#\" class=\"bt-features\"><span class=\"fa fa-plus icon\"></span>Tạo mới</a>\r\n            <a [routerLink]= \"['baocao']\" href=\"#\" class=\"bt-features\"><span class=\"fa fa-flag icon\"></span>Report</a>\r\n            <a class=\"bt-features disable\"><span class=\"fa fa-pencil-square icon\"></span>Set trạng thái</a>\r\n            <a class=\"bt-features disable\"><span class=\"fa fa-history icon\"></span>Lịch sử sửa đổi</a>\r\n            <!-- <a href=\"#\" class=\"bt-features\"><span class=\"fa fa-book icon\"></span>Bài viết</a> -->\r\n            <a class=\"bt-features disable\"><span class=\"fa fa-star icon\"></span>Theo dõi</a>\r\n            <!-- <share-button class=\"bt-features share\" [button]=\"fbButton\" ><span class=\"fa fa-fw fa-facebook-f icon\"></span></share-button>\r\n            <share-button class=\"bt-features\"  [button]=\"gPlusButton\"></share-button> -->\r\n            <div>\r\n                <!-- <a href=\"https://www.facebook.com/dialog/feed?\r\n                app_id=123454808277990\r\n                &display=page&amp;caption=\"+ {{name}} +\"\r\n                &description=\"+ {{description}} +\"\r\n                &link=\"+ {{link}} +\"\r\n                &redirect_uri=\" + {{link}}\r\n                    target=\"_blank\"> -->\r\n                <button class=\"bt-features share\" md-button shareButton=\"facebook\">\r\n                <span class=\"fa fa-facebook-official icon\"></span>\r\n                Facebook\r\n            </button>\r\n                <button class=\"bt-features share\" md-button shareButton=\"googleplus\">\r\n                    <i class=\"fa fa-google icon\"></i>\r\n                    Google+\r\n                </button>\r\n            </div>\r\n        </div>\r\n        <div class=\"content-left\" *ngIf=\"!loading\">\r\n            <div style=\"width:100%; float:left; overflow:auto; height:100%;\">\r\n                <!-- load mô tả chi tiết bệnh -->\r\n                <div class=\"content-main\">\r\n                    <div class=\"content-box-main scrollbar-custom\">\r\n                        <div class=\"title\">\r\n                            <h2>{{ChiTietBenh?.TenBenh}}</h2>\r\n                            <a href=\"#\" class=\"glyphicon glyphicon-pencil\"></a>\r\n\r\n            </div>\r\n            <hr class=\"thin bg-grayLighter\">\r\n\r\n            <div class=\"title-row\">\r\n                <h2 class=\"text-light\">Tóm tắt</h2>\r\n\r\n            </div>\r\n\r\n            <dd [innerHTML]=\"ChiTietBenh?.TomTat\"></dd>\r\n\r\n            <!-- load phần tử danh mục trong chi tiết bệnh -->\r\n            <div *ngFor=\"let phantu of ChiTietBenh?.DsPhanTu\">\r\n                <div class=\"title-row\">\r\n                    <h2 class=\"text-light\">\r\n                        {{phantu?.Ten}}\r\n                    </h2>\r\n                </div>\r\n                <hr class=\"thin bg-grayLighter\">\r\n                <!-- load dữ liệu chi tiết bệnh -->\r\n                <div *ngFor=\"let dulieu of phantu?.NoiDung?.DsDuLieuNoiDung\">\r\n\r\n                    <!-- load dữ liệu text -->\r\n                    <div *ngIf=\"dulieu?.LoaiDuLieu == 1\">\r\n                        <app-load-du-lieu-text [dulieuText]=\"dulieu?.Dulieu\">\r\n                        </app-load-du-lieu-text>\r\n                    </div>\r\n\r\n                    <!-- load dữ liệu ảnh -->\r\n                    <div *ngIf=\"dulieu?.LoaiDuLieu == 2\">\r\n                        <app-load-du-lieu-img [dulieuImg]=\"dulieu?.Dulieu\" [duLieuLinkAnh]=\"ChiTietBenh?.LinkAnh\" [dulieuImgTieuDe]=\"dulieu?.TieuDe\">\r\n                        </app-load-du-lieu-img>\r\n                        <br/>\r\n                        <br/>\r\n                    </div>\r\n\r\n                    <!-- load dữ liệu clip Youtube -->\r\n                    <div *ngIf=\"dulieu?.LoaiDuLieu == 5\">\r\n                        <app-load-du-lieu-youtube [dulieuYoutube]=\"dulieu?.Dulieu\" [dulieuYoutubeTieuDe]=\"dulieu?.TieuDe\">\r\n                        </app-load-du-lieu-youtube>\r\n                        <br/>\r\n                        <br/>\r\n                    </div>\r\n\r\n                    <!-- load dữ liệu link -->\r\n                    <div *ngIf=\"dulieu?.LoaiDuLieu == 10\">\r\n                        <app-load-du-lieu-link [dulieuLink]=\"dulieu?.Dulieu\" [dulieuLinkTieuDe]=\"dulieu?.TieuDe\">\r\n                        </app-load-du-lieu-link>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n\r\n    </div>\r\n    <div class=\"content-right\">\r\n        <div class=\"title\">\r\n            <h2>Phương pháp chữa trị</h2>\r\n        </div>\r\n        <div class=\"title\" *ngIf=\"ChiTietBenh?.DsChuyenKhoa[0]?.TenChuyenKhoa\">\r\n            <h2>Chuyên khoa</h2>\r\n        </div>\r\n        <div class=\"folder\">\r\n            <a> {{ChiTietBenh?.DsChuyenKhoa[0]?.TenChuyenKhoa}} </a>\r\n        </div>\r\n        <div class=\"title\">\r\n            <h2>Các chương trình y tế liên quan... (nghiên cứu, khám chữa)</h2>\r\n            <div class=\"theodoisua\">\r\n\r\n            </div>\r\n        </div>\r\n        <div class=\"title\">\r\n            <h2>Các trường hợp cụ thể (n case)</h2>\r\n            <div class=\"theodoisua\">\r\n\r\n            </div>\r\n        </div>\r\n        <div class=\"title\">\r\n            <h2>Trang thiết bị và dụng cụ y tế liên quan </h2>\r\n        </div>\r\n        <div class=\"title\">\r\n            <h2>Triệu chứng chính...</h2>\r\n        </div>\r\n        <div class=\"title\">\r\n            <h2>Các bệnh liên quan</h2>\r\n        </div>\r\n        <div class=\"title\">\r\n            <h2>Các thuốc liên quan </h2>\r\n        </div>\r\n        <div class=\"title\">\r\n            <h2>Các sai lầm hay gặp... </h2>\r\n        </div>\r\n        <div class=\"title\">\r\n            <h2>Các bài thuốc vị thuốc liên quan </h2>\r\n        </div>\r\n    </div>\r\n    </div>\r\n    </div>\r\n    <!-- end content left -->\r\n    <app-forum-bar *ngIf=\"!loading\">\r\n    </app-forum-bar>\r\n    </div>\r\n</app-window>\r\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ng2_metadata__ = __webpack_require__("../../../../ng2-metadata/index.js");
...
var ChiTietBenhComponent = (function () {
    function ChiTietBenhComponent(benhService, router, metadataService, titleService) {
    ...
    ChiTietBenhComponent.prototype.show = function (id) {
        ...
        if (this.ChiTietBenh == null || this.ChiTietBenh.id !== id) {
            this.benhService.getChiTietBenh(id).subscribe(function (data) {
                _this.ChiTietBenh = data;
                _this.name = data.TenBenh;
                _this.description = data.TomTat;
                _this.titleService.setTitle('Cloud Y Tế - ' + _this.name);
                _this.loading = false;
                _this.metadataService.setTitle('Cloud Y Tế - ' + _this.name);
                _this.metadataService.setTag('og:title ', _this.name);
                _this.metadataService.setTag('og:description ', _this.description);
            });
        }
    };
...
/***/ "../../../../../src/app/Share/Components/autoComplete/autoComplete.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/Share/Components/autoComplete/autoComplete.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"suggestions\" *ngIf=\"term\">\r\n    <ul *ngFor=\"let item of NameList\">\r\n        <li [class.active]=\"isActive(item)\">\r\n            <a (click)=\"select(item)\">{{item}}</a>\r\n        </li>\r\n    </ul>\r\n</div>\r\n"

/***/ }),

/***/ "../../../../../src/app/Share/Components/autoComplete/autoComplete.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Services_autoComplete_service__ = __webpack_require__("../../../../../src/app/Share/Services/autoComplete.service.ts");
...
var AutoCompleteComponent = (function () {
    function AutoCompleteComponent(AutoCompleteService, myElement) {
        this.AutoCompleteService = AutoCompleteService;
        this.ReturnData = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.isSearch = false;
        this._matches = [];
        this.empty = false;
        this.loading = false;
    ...
    AutoCompleteComponent.prototype.onChange = function (e) {
    ...
    AutoCompleteComponent.prototype.setActive = function (value) {
        this._active = value;
    };
    AutoCompleteComponent.prototype.hide = function () {
        this.NameList = [];
    };
    AutoCompleteComponent.prototype.prevActiveMatch = function () {
        var index = this.NameList.indexOf(this._active);
        this._active = this.NameList[index - 1 < 0 ? this.NameList.length - 1 : index - 1];
    };
    AutoCompleteComponent.prototype.nextActiveMatch = function () {
        var index = this.NameList.indexOf(this._active);
        this._active = this.NameList[index + 1 > this.NameList.length - 1 ? 0 : index + 1];
    };
    AutoCompleteComponent.prototype.doSearchAuto = function (text) {
        var _this = this;
        // no keyword catched => return all
        if (text === '') {
            this.isSearch = false;
            this.AutoCompleteService.autoComplete('', this.apiUrl).subscribe(function (data) {
                console.log(data);
                _this.ReturnDataList = data;
                _this.ReturnDataList.forEach(function (element) {
                    _this.NameList.push(element.Name);
                });
                _this.setActive(_this.NameList[0]);
            });
            ...
            this.isSearch = true;
            this.loading = true;
            this.AutoCompleteService.autoComplete(text, this.apiUrl).subscribe(function (data) {
                if (data === []) {
                    _this.NameList.push('Không có kết quả');
                }
                else {
                    _this.ReturnDataList = data;
                    _this.ReturnDataList.forEach(function (element) {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], AutoCompleteComponent.prototype, "apiUrl", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], AutoCompleteComponent.prototype, "term", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
    __metadata("design:type", Object)
], AutoCompleteComponent.prototype, "ReturnData", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostListener"])('keyup', ['$event']),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AutoCompleteComponent.prototype, "onChange", null);
AutoCompleteComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'app-autocomplete',
        template: __webpack_require__("../../../../../src/app/Share/Components/autoComplete/autoComplete.component.html"),
        // tslint:disable-next-line:use-host-property-decorator
        host: {
            '(document:click)': 'handleClick($event)',
        },
        styles: [__webpack_require__("../../../../../src/app/Share/Components/autoComplete/autoComplete.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__Services_autoComplete_service__["a" /* AutoCompleteService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__Services_autoComplete_service__["a" /* AutoCompleteService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _b || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ng2_metadata__ = __webpack_require__("../../../../ng2-metadata/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__window_window_component__ = __webpack_require__("../../../../../src/app/Share/Components/window/window.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Apps_Tracuubenh_chi_tiet_benh_chi_tiet_benh_component__ = __webpack_require__("../../../../../src/app/Apps/Tracuubenh/chi-tiet-benh/chi-tiet-benh.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_img_load_du_lieu_img_component__ = __webpack_require__("../../../../../src/app/Apps/Tracuubenh/chi-tiet-benh/Load-items/load-du-lieu-img/load-du-lieu-img.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_link_load_du_lieu_link_component__ = __webpack_require__("../../../../../src/app/Apps/Tracuubenh/chi-tiet-benh/Load-items/load-du-lieu-link/load-du-lieu-link.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_text_load_du_lieu_text_component__ = __webpack_require__("../../../../../src/app/Apps/Tracuubenh/chi-tiet-benh/Load-items/load-du-lieu-text/load-du-lieu-text.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_youtube_load_du_lieu_youtube_component__ = __webpack_require__("../../../../../src/app/Apps/Tracuubenh/chi-tiet-benh/Load-items/load-du-lieu-youtube/load-du-lieu-youtube.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__Apps_Tracuubenh_forum_bar_forum_bar_component__ = __webpack_require__("../../../../../src/app/Apps/Tracuubenh/forum-bar/forum-bar.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__Apps_Frame_winframe_winframe_component__ = __webpack_require__("../../../../../src/app/Apps/Frame/winframe/winframe.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__Apps_Frame_ChildFrame_ChildFrame_component__ = __webpack_require__("../../../../../src/app/Apps/Frame/ChildFrame/ChildFrame.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__autoComplete_autoComplete_component__ = __webpack_require__("../../../../../src/app/Share/Components/autoComplete/autoComplete.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__Share_Pipes_safe_pipe__ = __webpack_require__("../../../../../src/app/Share/Pipes/safe.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__Services_setting_service__ = __webpack_require__("../../../../../src/app/Share/Services/setting.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__Services_autoComplete_service__ = __webpack_require__("../../../../../src/app/Share/Services/autoComplete.service.ts");
...
ShareModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2_ng2_completer__["a" /* Ng2CompleterModule */],
            __WEBPACK_IMPORTED_MODULE_6_ngx_sharebuttons__["a" /* ShareButtonsModule */],
            __WEBPACK_IMPORTED_MODULE_5_ngx_facebook__["a" /* FacebookModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_3_ng2_metadata__["a" /* MetadataModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_7__angular_router__["a" /* RouterModule */]
        ],
        declarations: [
            __WEBPACK_IMPORTED_MODULE_9__window_window_component__["a" /* WindowComponent */],
            __WEBPACK_IMPORTED_MODULE_19__Share_Pipes_safe_pipe__["a" /* SafePipe */],
            __WEBPACK_IMPORTED_MODULE_10__Apps_Tracuubenh_chi_tiet_benh_chi_tiet_benh_component__["a" /* ChiTietBenhComponent */],
            __WEBPACK_IMPORTED_MODULE_11__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_img_load_du_lieu_img_component__["a" /* LoadDuLieuImgComponent */],
            __WEBPACK_IMPORTED_MODULE_12__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_link_load_du_lieu_link_component__["a" /* LoadDuLieuLinkComponent */],
            __WEBPACK_IMPORTED_MODULE_13__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_text_load_du_lieu_text_component__["a" /* LoadDuLieuTextComponent */],
            __WEBPACK_IMPORTED_MODULE_14__Apps_Tracuubenh_chi_tiet_benh_Load_items_load_du_lieu_youtube_load_du_lieu_youtube_component__["a" /* LoadDuLieuYoutubeComponent */],
            __WEBPACK_IMPORTED_MODULE_15__Apps_Tracuubenh_forum_bar_forum_bar_component__["a" /* ForumBarComponent */],
            __WEBPACK_IMPORTED_MODULE_16__Apps_Frame_winframe_winframe_component__["a" /* WinframeComponent */],
            __WEBPACK_IMPORTED_MODULE_17__Apps_Frame_ChildFrame_ChildFrame_component__["a" /* ChildFrameComponent */],
            __WEBPACK_IMPORTED_MODULE_18__autoComplete_autoComplete_component__["a" /* AutoCompleteComponent */]
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_9__window_window_component__["a" /* WindowComponent */],
            __WEBPACK_IMPORTED_MODULE_19__Share_Pipes_safe_pipe__["a" /* SafePipe */],
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_21__Services_autoComplete_service__["a" /* AutoCompleteService */],
...
/***/ "../../../../../src/app/Share/Pipes/safe.pipe.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "../../../../../src/app/Share/Services/autoComplete.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var AutoCompleteService = (function () {
    ...
    AutoCompleteService.prototype.autoComplete = function (key, apiUrl) {
        var autoCompleteUrl = this.baseUrl + "CSDLYT/" + apiUrl + "?term=" + key;
...
var BenhService = (function () {
    ...
    BenhService.prototype.getChiTietBenh = function (id) {
        var chiTietBenhUrl;
        if (isNaN(id)) {
            chiTietBenhUrl = __WEBPACK_IMPORTED_MODULE_1__environments_environment_prod__["a" /* environment */].apiUrl + "CSDLYT/Benh_Detail?ten=" + id;
        }
        else {
            chiTietBenhUrl = __WEBPACK_IMPORTED_MODULE_1__environments_environment_prod__["a" /* environment */].apiUrl + "CSDLYT/Benh_Detail?Id=" + id;
        }
        // ...using get request
...
var Benh = (function () {
    function Benh(id, Name, Ten, Loai, LoaiDuLieu, Dulieu, TieuDe) {
        this.id = id;
        this.Name = Name;
        this.Ten = Ten;
        this.Loai = Loai;
...
var RemoteData = (function (_super) {
    ...
    RemoteData.prototype.search = function (term) {
        ...
        if (!this._requestOptions) {
            this._requestOptions = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["RequestOptions"]();
            this._requestOptions.headers = this._headers || new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        }
...
/***/ "../../../../ng2-metadata/index.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_metadata_service__ = __webpack_require__("../../../../ng2-metadata/src/metadata.service.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_models_page_title_positioning__ = __webpack_require__("../../../../ng2-metadata/src/models/page-title-positioning.js");
/* unused harmony namespace reexport */
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_1__src_metadata_service__["a"]; });
/* unused harmony export metadataLoaderFactory */
...
function metadataLoaderFactory() {
    return new __WEBPACK_IMPORTED_MODULE_1__src_metadata_service__["b" /* MetadataStaticLoader */]();
}
var MetadataModule = MetadataModule_1 = (function () {
    function MetadataModule() {
    }
    MetadataModule.forRoot = function (providedLoader) {
        if (providedLoader === void 0) { providedLoader = {
            provide: __WEBPACK_IMPORTED_MODULE_1__src_metadata_service__["c" /* MetadataLoader */],
        ...
        return {
            ...
            providers: [
                providedLoader,
                __WEBPACK_IMPORTED_MODULE_1__src_metadata_service__["a" /* MetadataService */]
            ]
        };
    };
...
/***/ "../../../../ng2-metadata/src/metadata.service.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_page_title_positioning__ = __webpack_require__("../../../../ng2-metadata/src/models/page-title-positioning.js");
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return MetadataLoader; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return MetadataStaticLoader; });
...
var MetadataStaticLoader = (function () {
    function MetadataStaticLoader(metadataSettings) {
        if (metadataSettings === void 0) { metadataSettings = {
            pageTitlePositioning: __WEBPACK_IMPORTED_MODULE_5__models_page_title_positioning__["a" /* PageTitlePositioning */].PrependPageTitle,
            defaults: {}
        }; }
...
var MetadataService = (function () {
    function MetadataService(router, document, titleService, activatedRoute, loader) {
        ...
        this.isMetadataSet = {};
        this.router.events
            .filter(function (event) { return (event instanceof __WEBPACK_IMPORTED_MODULE_2__angular_router__["e" /* NavigationEnd */]); })
    ...
    MetadataService.prototype.setTitle = function (title, override) {
        ...
        switch (this.metadataSettings.pageTitlePositioning) {
            case __WEBPACK_IMPORTED_MODULE_5__models_page_title_positioning__["a" /* PageTitlePositioning */].AppendPageTitle:
                title = (!override
                ...
                break;
            case __WEBPACK_IMPORTED_MODULE_5__models_page_title_positioning__["a" /* PageTitlePositioning */].PrependPageTitle:
...
MetadataService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
    __param(1, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["e" /* DOCUMENT */])),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* Router */], Object, __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["b" /* Title */],
        __WEBPACK_IMPORTED_MODULE_2__angular_router__["d" /* ActivatedRoute */],
        MetadataLoader])
], MetadataService);
...
/***/ "../../../../ng2-metadata/src/models/page-title-positioning.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PageTitlePositioning; });
