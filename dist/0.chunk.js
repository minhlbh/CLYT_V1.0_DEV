...
var AutoCompleteComponent = (function () {
    function AutoCompleteComponent(AutoCompleteService, completerService) {
        var _this = this;
    ...
    AutoCompleteComponent.prototype.doSearchAutoBenh = function (text) {
        ...
        if (text === '') {
            ...
            setTimeout(function () {
                _this.AutoCompleteService.autoComplete(text, _this.apiUrl).subscribe(function (data) {
...
AutoCompleteComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__Services_autoComplete_service__["a" /* AutoCompleteService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__Services_autoComplete_service__["a" /* AutoCompleteService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3_ng2_completer__["b" /* CompleterService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ng2_completer__["b" /* CompleterService */]) === "function" && _b || Object])
...
var AutoCompleteService = (function () {
    ...
    AutoCompleteService.prototype.autoComplete = function (key, apiUrl) {
        var autoCompleteUrl = this.baseUrl + "CSDLYT/" + apiUrl + "?Trang=1&searchTerm=" + key + "&soluongmoitrang=15";
