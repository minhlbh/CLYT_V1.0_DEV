...
var ChangePassComponent = (function () {
    function ChangePassComponent(settingService, router, activedroute, userService) {
        ...
        this.verifyCode = new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["FormControl"]();
        this.newPassword = new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["FormControl"]();
...
var EnterPhoneNumberComponent = (function () {
    function EnterPhoneNumberComponent(settingService, router, activedroute, userService) {
        ...
        this.activedroute = activedroute;
        this.userService = userService;
        this.phone = new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["FormControl"]();
        this.elements = this.settingService.getConfig();
        this._regInfo = {
            phone: '',
            id: '',
...
var RegisterComponent = (function () {
    function RegisterComponent(settingService, router, _auth, userService) {
        ...
        this.userService = userService;
        this.error = null;
        this.name = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormControl"]();
        this.phone = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormControl"]();
