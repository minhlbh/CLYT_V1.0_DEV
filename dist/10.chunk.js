...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Share_Services_autoComplete_service__ = __webpack_require__("../../../../../src/app/Share/Services/autoComplete.service.ts");
...
var DanhSachBenhComponent = (function () {
    function DanhSachBenhComponent(
        ...
        benhService, router, activedroute, settingService, AutoCompleteService) {
        this.benhService = benhService;
        this.router = router;
